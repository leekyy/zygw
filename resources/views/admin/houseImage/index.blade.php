        ...
        <div class="modal-dialog">
            <div class="modal-content message_align">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">管理楼盘图</h4>
                </div>
                <form id="editHouseLabel" action="{{URL::asset('/admin/houseImage/edit')}}" method="post"
...
@section('script')
    <script type="application/javascript">
        ...
        function clickDel(ad_id) {
            ...
            $("#tipModalBody").html('<p>楼盘图片数据关联较多信息，请联系管理员处理</p>');
            $("#tipModal").modal('show');
        }

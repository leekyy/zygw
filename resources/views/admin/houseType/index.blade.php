        ...
        <div class="modal-dialog">
            <div class="modal-content message_align">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">管理楼盘类型图</h4>
                </div>
                <form id="editHouseLabel" action="{{URL::asset('/admin/houseType/edit')}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="name" name="name" type="text" class="form-control"
                                           placeholder="请输入楼盘类型名称，例如小高层、洋房等"
                                           value="">
                                </div>
                            </div>
                        </div>
...
@section('script')
    <script type="application/javascript">
        ...
        function clickDel(ad_id) {
            ...
            $("#tipModalBody").html('<p>楼盘类型数据关联较多信息，请联系管理员处理</p>');
            $("#tipModal").modal('show');
        }

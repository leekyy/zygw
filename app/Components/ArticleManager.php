...
class ArticleManager
{
    ...
    {
        $ads = ArticleTWStep::where('status', '=', '0')->orderby('seq', 'desc')->get();
        return $ads;
    }
    ...
    {
        $ad = ArticleTWStep::where('id', '=', $id)->first();
        return $ad;
    }
    ...
    {
        $ads = HeZuo::orderBy('seq', 'desc')->orderBy('id', 'desc')->paginate(Utils::PAGE_SIZE);
        return $ads;
    }

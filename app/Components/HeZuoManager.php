...
class HeZuoManager
{
    ...
    {
        $xjs = HeZuo::orderby('id', 'desc')->where('status', '=', '1');
    ...
    {
        $xjs = HeZuo::orderby('id', 'desc')->paginate(Utils::PAGE_SIZE);
        return $xjs;
    }
    /*
     * 获取全部生效合作细则信息
     ...
     *
     */
    public static function setHeZuoStep($tw_step, $data)
    {

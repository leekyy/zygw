...
class RuleController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.goodsexchange.rule', ['admin' => $admin, 'datas' => $ads, 'upload_token' => $upload_token]);
    }
    ...
    public function setStatus(Request $request, $id)
    {
        ...
        $ad->status = $opt;
        $ad->save();
        return redirect('/admin/goodsexchange/rule');
    }
    ...
    public function getById(Request $request)
    {
        ...
        $admin = RuleManager::getById($data['id']);
    ...
    public function edit(Request $request)
    {
        ...
        if (array_key_exists('id', $data)) {
            $ad = Rules::find($data['id']);
        }
        $admin = $request->session()->get('admin');
        //生成七牛token
        $upload_token = QNManager::uploadToken();
        return view('admin.rule.edit', ['admin' => $admin, 'data' => $ad, 'upload_token' => $upload_token]);
    }

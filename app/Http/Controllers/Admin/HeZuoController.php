...
class HeZuoController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.hezuo.index', ['admin' => $admin, 'datas' => $ads, 'upload_token' => $upload_token]);
    }
    ...
    public function getById(Request $request)
    {
        ...
        $admin = HeZuoManager::getById($data['id']);
    ...
    public function edit(Request $request)
    {
        ...
        if (array_key_exists('id', $data)) {
            $ad = HeZuo::find($data['id']);
        }
        $admin = $request->session()->get('admin');
        //生成七牛token
        $upload_token = QNManager::uploadToken();
        return view('admin.hezuo.edit', ['admin' => $admin, 'data' => $ad, 'upload_token' => $upload_token]);
    }

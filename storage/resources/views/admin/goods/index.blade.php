                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            @foreach($datas as $data)
                                <tr id="tr_{{$data->id}}">
                                    ...
                                    <td>
                                        <div class="line-height-30">
                                            <img src="{{$data->image}}?imageView2/1/w/60/h/40/interlace/1/q/75|imageslim">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="line-height-30">
                                    ...
                                    <td>
                                        @if($data->status === '0')
                                            <span class="label label-default line-height-30">下架</span>
                                        @else
                                            <span class="label label-success line-height-30">上架</span>
                                        @endif
                                    </td>
                                    <td>
                                        <span class="line-height-30">
                                            <a href="{{URL::asset('/admin/goods/setStatus')}}/{{$data->id}}?status=1"
                                               class="btn btn-social-icon btn-info margin-right-10 opt-btn-size"
                                               data-toggle="tooltip"
                                               data-placement="top" title="在小程序页面中上架该商品">
                                                <i class="fa fa-eye opt-btn-i-size"></i>
                                            </a>
                                            <a href="{{URL::asset('/admin/goods/setStatus')}}/{{$data->id}}?status=0"
                                               class="btn btn-social-icon btn-warning margin-right-10 opt-btn-size"
                                               data-toggle="tooltip"
                                               data-placement="top" title="在小程序页面中下架该商品">
    ...
    <div class="modal fade -m" id="addGoodsModal" tabindex="-1" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content message_align">
                ...
                <form id="editAD" action="{{URL::asset('/admin/goods/edit')}}" method="post" class="form-horizontal"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="jifen" class="col-sm-2 control-label">积分价值*</label>

                                <div class="col-sm-10">
                                    <input id="jifen" name="jifen" type="number" class="form-control"
                                           placeholder="请输入兑换积分值"
                                           value="0">
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" id="addGoodsModal_confirm_btn" data-value=""
...
@section('script')
    <script type="application/javascript">
        ...
        function delGoods() {
            ...
            //进行页面跳转
            window.location.href = "{{URL::asset('/admin/goods/del')}}/" + goods_id;
        }
        ...
        function clickEdit(goods_id) {
            ...
            getGoodsById("{{URL::asset('')}}", {id: goods_id, _token: "{{ csrf_token() }}"}, function (ret) {
                if (ret.result) {
                    var msgObj = ret.ret;
                    //对象配置
                    $("#id").val(msgObj.id);

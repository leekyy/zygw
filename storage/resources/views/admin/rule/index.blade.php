    ...
    <section class="content-header">
        <div class="row">
            ...
            <div class="col-lg-6 text-right">
                <a href="{{URL::asset('/admin/rule/editRule')}}">
                                    ...
                                    <td>
                                        <div class="line-height-30 ">
                                            <a href="{{URL::asset('/admin/rule/setStatus')}}/{{$data->id}}?opt=1"
                                               ...
                                               data-toggle="tooltip"
                                               data-placement="top" title="生效的积分兑换规则图文才可以推送给客户">
                                            ...
                                            <a href="{{URL::asset('/admin/rule/setStatus')}}/{{$data->id}}?opt=0"
                                               ...
                                               data-toggle="tooltip"
                                               data-placement="top" title="失效的积分兑换规则图文不会推送给客户">
                                                <i class="fa fa-eye-slash opt-btn-i-size"></i>
                                            </a>
                                            <a href="{{URL::asset('/admin/rule/editRule')}}?id={{$data->id}}"
...
@section('script')
    <script type="application/javascript">
        ...
        function delXJ() {
            ...
            $("#tr_" + xj_id).fadeOut();
            //进行页面跳转
            window.location.href = "{{URL::asset('/admin/rule/del')}}/" + xj_id;
        }
    </script>
@endsection